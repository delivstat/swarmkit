...
from swael_runtime.authoring import run_authoring_session
from swael_runtime.authoring._prompts import AuthoringMode
from swael_runtime.errors import ResolutionError, ResolutionErrors
from swael_runtime.gaps import SkillGapLog
from swael_runtime.resolver import ResolvedWorkspace, resolve_workspace
from swael_runtime.review import FileReviewQueue
...
def _save_run_log(ws_root: Path, topology: str, result: RunResult) -> None:
    """Save run events to .swael/logs/ as JSONL for later analysis."""
    if not result.events:
        return
    from datetime import UTC, datetime  # noqa: PLC0415

    log_dir = ws_root / ".swael" / "logs"
...
def logs(
    ...
    Reads from .swael/logs/*.jsonl saved by swarmkit run.
    Use --format markdown for a compliance-ready audit report.
    """
    log_dir = workspace_path.resolve() / ".swael" / "logs"
...
def why(
    ...
    from swael_runtime.model_providers import CompletionRequest, Message  # noqa: PLC0415
...
def knowledge_server(
    ...
    from swael_runtime.knowledge._server import run_server  # noqa: PLC0415
