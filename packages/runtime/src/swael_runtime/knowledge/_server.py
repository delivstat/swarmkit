...
from swael_runtime.cli._knowledge import find_repo_root
...
def validate_workspace(path: str) -> dict[str, Any]:
    ...
    from swael_runtime.errors import ResolutionErrors  # noqa: PLC0415
    from swael_runtime.resolver import resolve_workspace  # noqa: PLC0415
