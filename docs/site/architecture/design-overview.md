...
| **swarmkit-schema** | JSON Schema + Python + TypeScript | Canonical schemas for 11 artifact kinds (topology, workspace, archetype, skill, funnel, stage-graph, contract, role-registry, approval-policy, trigger, executor-adapter), validators, codegen |
