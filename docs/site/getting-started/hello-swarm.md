...
SWARMKIT_PROVIDER=openrouter SWARMKIT_MODEL=meta-llama/llama-3.3-70b-instruct \
  swael run examples/hello-swarm/workspace hello \
...
See [`examples/hello-swarm/README.md`](https://github.com/delivstat/swael/tree/main/examples/hello-swarm) for the full walkthrough.
