...
description: Per-PR checklist for friction reduction. SwarmKit trades on being easy to start and easy to grow; every PR reinforces that or dilutes it.
...
SwarmKit's design doc §7 already declares "Ergonomics determine adoption." This note is the operational version — a checklist every PR reviewer (human or tool) runs through before approving.
...
- [ ] **First-time-user test:** could a user with no prior SwarmKit context complete this task without reading the design doc? If no, what changed their position?
...
- `design/SwarmKit-Design-v0.6.md` §7 Architectural Principles (Ergonomics determine adoption)
- `design/SwarmKit-Design-v0.6.md` §3.4 The first-run promise
- `docs/notes/llm-friendly-knowledge.md` — how LLMs help close the gap
- Task #23: human-readable `swarmkit validate` errors — the first concrete landing of this discipline
