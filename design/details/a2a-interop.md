...
question waits bounded rather than parking the run. Still design: `pack:workspace`, the portal's
"Add an A2A agent by card URL", the harness gateway offering agent skills, the fleet listing.
