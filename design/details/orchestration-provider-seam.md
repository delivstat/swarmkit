...
the hard engine, don't rebuild it), [`stage-graph` schema](../../packages/schema/schemas/stage-graph.schema.json).
**Status:** proposed.
...
- The **pipeline editor** ([`pipeline-editor-canvas.md`](pipeline-editor-canvas.md)) is unaffected —
